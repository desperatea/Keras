# USAGE
# python predict.py --model output/simple_nn.model --label-bin output/simple_nn_lb.pickle
# --width 32 --height 32 --flatten 1 --image images/dog.jpg

# python predict.py --model output/smallvggnet.model --label-bin output/smallvggnet_lb.pickle
# --width 64 --height 64 --image images/dog.jpg
...
ap.add_argument("-sh", "--show", type=bool, default=False, help="should or not show image on window")
ap.add_argument("-s", "--save", type=bool, default=True, help="should or not save image result to results folder")
...
if args["save"]:
    ...
    cv2.imwrite('images_results/' + tail, output)
